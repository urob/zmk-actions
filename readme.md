...
jobs:
  upgrade-zmk:
    uses: urob/zmk-actions/.github/workflows/upgrade-zmk.yml@v12.1.0
    permissions:
      contents: write
    secrets:
...
jobs:
  test:
    uses: urob/zmk-actions/.github/workflows/run-tests.yml@v12.1.0
```
...
jobs:
  release:
    uses: urob/zmk-actions/.github/workflows/upgrade-module.yml@v12.1.0
    permissions:
      contents: write
```
