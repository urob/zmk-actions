...
jobs:
  upgrade-zmk:
    uses: urob/zmk-actions/.github/workflows/upgrade-zmk.yml@v7.2.0
    permissions:
      contents: write
    secrets:
...
jobs:
  test:
    uses: urob/zmk-actions/.github/workflows/run-tests.yml@v7.2.0
```
...
jobs:
  release:
    uses: urob/zmk-actions/.github/workflows/upgrade-module.yml@v7.2.0
    permissions:
      contents: write
```
