...
jobs:
  upgrade-zmk:
    uses: urob/zmk-actions/.github/workflows/upgrade-zmk.yml@zephyr-4.1
    permissions:
      contents: write
    secrets:
...
jobs:
  test:
    uses: urob/zmk-actions/.github/workflows/run-tests.yml@zephyr-4.1
```
...
jobs:
  release:
    uses: urob/zmk-actions/.github/workflows/upgrade-module.yml@zephyr-4.1
    permissions:
      contents: write
```
